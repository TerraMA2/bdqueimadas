...
var terrama2Interval = window.setInterval(function() {
  if(TerraMA2WebComponents.obj.isComponentsLoaded()) {
    ...
    TerraMA2WebComponents.webcomponents.MapDisplay.addTileWMSLayer(
      serverConfig.Servers.Local.URL,
      serverConfig.Servers.Local.Type,
      serverConfig.Servers.Local.StatesLayerId,
      serverConfig.Servers.Local.StatesLayerId,
      true,
    ...
    TerraMA2WebComponents.webcomponents.MapDisplay.addTileWMSLayer(
      serverConfig.Servers.Local.URL,
      serverConfig.Servers.Local.Type,
      serverConfig.Servers.Local.CountriesLayerId,
      serverConfig.Servers.Local.CountriesLayerId,
      true,
    ...
    TerraMA2WebComponents.webcomponents.MapDisplay.addTileWMSLayer(
      serverConfig.Servers.Local.URL,
      serverConfig.Servers.Local.Type,
      serverConfig.Servers.Local.FiresLayerId,
      serverConfig.Servers.Local.FiresLayerId,
      true,
    ...
    TerraMA2WebComponents.webcomponents.MapDisplay.addTileWMSLayer(
      serverConfig.Servers.Local.URL,
      serverConfig.Servers.Local.Type,
      serverConfig.Servers.Local.FiresChoroplethLayerId,
      serverConfig.Servers.Local.FiresChoroplethLayerId,
      true,
    ...
    TerraMA2WebComponents.webcomponents.MapDisplay.addCapabilitiesLayers(
      serverConfig.Servers.Local.URL + serverConfig.Servers.Local.CapabilitiesParams,
      serverConfig.Servers.Local.URL,
      'geoserver',
      'local',
      'Local Server',
